...
class FinishedApprovalRequestNotification extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'title'         => __('dashboard.title_finished_approval_request', ['flow' => $this->approvalRequest?->approvalFlow?->name]),
            'message'       => __('dashboard.finished_approval_request', ['employee' => $this->user?->name]),
