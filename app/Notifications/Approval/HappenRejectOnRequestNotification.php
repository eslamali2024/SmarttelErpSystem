...
class HappenRejectOnRequestNotification extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'title'         => __('dashboard.title_reject_on_request', ['flow' => $this->approvalRequest?->approvalFlow?->name]),
            'message'       => __('dashboard.reject_on_request', ['flow' => $this->approvalRequest?->approvalFlow?->name]),
